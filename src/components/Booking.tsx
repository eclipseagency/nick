                      ...
                      {s.id === "tint-plus" && size === "small" ? (
                        <div style={{
                          ...
                          {[
                            ...
                            d("ضمان ١٠ سنوات", "10-year warranty"),
                          ].map((feat, i) => (
