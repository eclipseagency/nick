...
export default function Booking() {
  ...
  const svcs: Svc[] = [
    ...
    { id: "tint-plus", cat: "tint", tier: "Plus", name: t.booking.svcTintPlus, p: sp("tint-plus", { small: 1380, large: 1580 }), pBefore: { small: 1600, large: 1800 }, w: "10yr", duration: "2-3 hrs", img: "", imgSmall: "/images/tint-full-small.webp", imgLarge: "/images/tint-full-large.webp", addonTier: "low", parts: [t.booking.allGlass], details: [...tintSideDesc, d("التخفيف الفعال للحرارة", "Effective heat reduction"), d("تقليص وهج الشمس ومصادر الضوء الضارة", "Reduces sun glare and harmful light sources"), d("تحسين المظهر العام للمركبة", "Enhances the overall appearance of the vehicle"), d("حماية من تناثر الزجاج في حال حدوث كسر", "Protection from glass shattering in case of breakage"), d("يتوفر بدرجات وألوان مختلفة", "Available in various shades and colors"), d("ضمان 10 سنوات", "10-year warranty")], shortDesc: d("العازل يشمل الزجاج الجانبي والخلفي فقط", "Covers side and rear windows only"), popular: true },
                    ...
                    <div style={{ position: "relative", height: hasCoverageImg(s) ? "auto" : 140, aspectRatio: hasCoverageImg(s) ? "1" : undefined, background: "#0a0a0a" }}>
                      {s.id === "tint-plus" && size === "small" ? (
                        <div style={{
                          ...
                          {[
                            d("التخفيف الفعال للحرارة", "Effective heat reduction"),
                            d("تقليص وهج الشمس ومصادر الضوء الضارة", "Reduces sun glare and harmful light"),
                            d("تحسين المظهر العام للمركبة", "Enhances vehicle appearance"),
                            d("حماية من تناثر الزجاج في حال حدوث كسر", "Protection from glass shattering"),
                            d("يتوفر بدرجات وألوان مختلفة", "Available in various shades and colors"),
                            d("ضمان 10 سنوات", "10-year warranty"),
                          ].map((feat, i) => (
