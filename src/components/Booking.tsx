...
export default function Booking() {
  ...
  const svcs: Svc[] = [
    ...
    { id: "tint-plus", cat: "tint", tier: "Plus", name: t.booking.svcTintPlus, p: sp("tint-plus", { small: 1380, large: 1580 }), pBefore: { small: 1600, large: 1800 }, w: "10yr", duration: "2-3 hrs", img: "", imgSmall: "/images/tint-full-small.webp", imgLarge: "/images/tint-full-large.webp", addonTier: "low", parts: [t.booking.allGlass], details: [d("تقليل فعال للحرارة", "Effective heat reduction"), d("تقليل الوهج الناتج عن أشعة الشمس ومصادر الضوء الضارة", "Reduced glare from sunlight and harmful light sources"), d("تحسين المظهر العام للمركبة", "Improved overall vehicle appearance"), d("حماية ضد تطاير الزجاج في حالة الكسر", "Protection against glass shattering in case of breakage"), d("متوفر بدرجات وألوان مختلفة", "Available in different shades and colors"), d("ضمان لمدة 10 سنوات", "10-year warranty")], shortDesc: d("العازل يشمل الزجاج الجانبي والخلفي فقط", "Covers side and rear windows only"), popular: true },
