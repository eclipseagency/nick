...
export default function Booking() {
  ...
  const svcs: Svc[] = [
    ...
    { id: "tint-plus", cat: "tint", tier: "Plus", name: t.booking.svcTintPlus, p: sp("tint-plus", { small: 1380, large: 1580 }), pBefore: { small: 1500, large: 1700 }, w: "10yr", duration: "2-3 hrs", img: "", imgSmall: "/images/tint-full-small.webp", imgLarge: "/images/tint-full-large.webp", addonTier: "low", parts: [t.booking.allGlass], details: [d("عازل بتقنية النانو سيراميك المتطورة", "Advanced nano ceramic insulation technology"), d("العازل يشمل الزجاج الجانبي والخلفي فقط", "Covers side and rear windows only")], shortDesc: d("العازل يشمل الزجاج الجانبي والخلفي", "The insulation includes the side and rear windows."), popular: true },
