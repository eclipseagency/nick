...
export default function Booking() {
  ...
  const svcs: Svc[] = [
    ...
    { id: "ppf-interior", cat: "ppf", name: t.booking.svcPpfInterior, p: sp("ppf-interior", { small: 1180, large: 1580 }), pBefore: { small: 1400, large: 1950 }, w: "10yr", img: "", imgSmall: "/images/ppf-interior-small.png", imgLarge: "/images/ppf-interior-large.png", addonTier: "low", parts: [t.booking.interiorSurfaces], details: ["سهولة التنظيف دون التأثير على جودة الأسطح الحساسة", "حماية الشاشات والبيانو بلاك والكاربون فايبر من الخدوش"] },
    { id: "tint-plus", cat: "tint", name: t.booking.svcTintPlus, p: sp("tint-plus", { small: 1380, large: 1580 }), pBefore: { small: 1600, large: 1800 }, w: "10yr", img: "", imgSmall: "/images/tint-full-small.png", imgLarge: "/images/tint-full-large.png", addonTier: "low", parts: [t.booking.allGlass], details: ["عازل بتقنية النانو سيراميك المتطورة", "العازل يشمل الزجاج الجانبي والخلفي فقط"], popular: true },
    { id: "tint-flex", cat: "tint", name: t.booking.svcTintFlex, p: sp("tint-flex", { small: 1180, large: 1380 }), pBefore: { small: 1300, large: 1500 }, w: "8yr", img: "", imgSmall: "/images/tint-full-small.png", imgLarge: "/images/tint-full-large.png", addonTier: "low", parts: [t.booking.allGlass], details: ["عازل حراري بتقنية النانو سيراميك", "العازل يشمل الزجاج الجانبي والخلفي فقط"] },
    { id: "tint-lite", cat: "tint", name: t.booking.svcTintLite, p: sp("tint-lite", { small: 900, large: 1080 }), pBefore: { small: 1000, large: 1200 }, w: "5yr", img: "", imgSmall: "/images/tint-full-small.png", imgLarge: "/images/tint-full-large.png", addonTier: "low", parts: [t.booking.allGlass], details: ["عازل حراري بتقنية النانو سيراميك", "العازل يشمل الزجاج الجانبي والخلفي فقط"] },
    { id: "tint-front-max", cat: "tint", name: t.booking.svcTintFrontMax, p: sp("tint-front-max", { small: 780, large: 880 }), w: "10yr", img: "", imgSmall: "/images/tint-windshield-small.png", imgLarge: "/images/tint-windshield-large.png", addonTier: "high", parts: [t.booking.frontWindshield], details: ["وضوح عالي", "قوة في العزل", "يدعم رؤية القيادة الليلية", "يقلل من توهج حرارة الشمس", "يظهر باللون الأرجواني الفريد كزجاج سيارة رولزرويس", "مدعوم بتقنية الرش المغناطيسي المزدوج"] },
    { id: "tint-front-pro", cat: "tint", name: t.booking.svcTintFrontPro, p: sp("tint-front-pro", { small: 660, large: 760 }), w: "10yr", img: "", imgSmall: "/images/tint-windshield-small.png", imgLarge: "/images/tint-windshield-large.png", addonTier: "high", parts: [t.booking.frontWindshield], details: ["وضوح عالي", "قوة في العزل", "يدعم رؤية القيادة الليلية", "يقلل من توهج حرارة الشمس", "مدعوم بتقنية الرش المغناطيسي المزدوج"] },
    { id: "tint-front-plus", cat: "tint", name: t.booking.svcTintFrontPlus, p: sp("tint-front-plus", { small: 375, large: 475 }), w: "10yr", img: "", imgSmall: "/images/tint-windshield-small.png", imgLarge: "/images/tint-windshield-large.png", addonTier: "high", parts: [t.booking.frontWindshield], details: ["وضوح عالي", "عازل بتقنية النانو سيراميك المتطورة"] },
    { id: "tint-front-flex", cat: "tint", name: t.booking.svcTintFrontFlex, p: sp("tint-front-flex", { small: 225, large: 325 }), w: "8yr", img: "", imgSmall: "/images/tint-windshield-small.png", imgLarge: "/images/tint-windshield-large.png", addonTier: "high", parts: [t.booking.frontWindshield], details: ["وضوح عالي", "عازل حراري بتقنية النانو سيراميك"] },
    { id: "tint-front-lite", cat: "tint", name: t.booking.svcTintFrontLite, p: sp("tint-front-lite", { small: 185, large: 285 }), w: "5yr", img: "", imgSmall: "/images/tint-windshield-small.png", imgLarge: "/images/tint-windshield-large.png", addonTier: "high", parts: [t.booking.frontWindshield], details: ["وضوح عالي", "عازل حراري بتقنية النانو سيراميك"] },
    { id: "ceramic-int-1", cat: "ceramic", name: t.booking.svcCeramicInt1, p: sp("ceramic-int-1", { small: 1880, large: 2180 }), pBefore: { small: 2350, large: 2750 }, w: "1yr", img: "", imgSmall: "/images/ceramic-int-small.png", imgLarge: "/images/ceramic-int-large.png", addonTier: "low", parts: [t.booking.interiorSurfaces], details: ["سهولة التنظيف", "مقاومة تسرب المواد السائلة داخل المراتب"] },
    { id: "ceramic-ext-1", cat: "ceramic", name: t.booking.svcCeramicExt1, p: sp("ceramic-ext-1", { small: 1180, large: 1280 }), pBefore: { small: 1550, large: 1750 }, w: "1yr", img: "", imgSmall: "/images/ceramic-ext1-small.png", imgLarge: "/images/ceramic-ext1-large.png", addonTier: "high", parts: [t.booking.exteriorBody], details: ["تلميع ساطع", "4 طبقات خلال فترة الضمان"] },
    { id: "ceramic-ext-3", cat: "ceramic", name: t.booking.svcCeramicExt3, p: sp("ceramic-ext-3", { small: 1480, large: 1780 }), pBefore: { small: 2550, large: 2750 }, w: "3yr", img: "", imgSmall: "/images/ceramic-ext3-small.png", imgLarge: "/images/ceramic-ext3-large.png", addonTier: "low", parts: [t.booking.exteriorBody], details: ["تلميع ساطع", "10 طبقات خلال فترة الضمان"], popular: true },
    { id: "ceramic-ext-5", cat: "ceramic", name: t.booking.svcCeramicExt5, p: sp("ceramic-ext-5", { small: 1780, large: 1980 }), pBefore: { small: 2950, large: 3250 }, w: "5yr", img: "", imgSmall: "/images/ceramic-ext5-small.png", imgLarge: "/images/ceramic-ext5-large.png", addonTier: "low", parts: [t.booking.exteriorBody], details: ["تلميع ساطع", "12 طبقة خلال فترة الضمان"] },
  ];
