  ...
  return (
    <section
      ...
      style={{
        ...
        minHeight: isMobile ? undefined : 650,
        overflow: "hidden",
        background: "#050505",
        padding: isMobile ? "80px 12px 24px" : undefined,
      }}
    >
      {/* Gold dust particles — desktop only */}
      {!isMobile && (
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h1 className="hero-reveal-2" style={{
                ...
                fontWeight: 900, lineHeight: 1.05, margin: "0 0 8px",
              ...
              <p className="hero-reveal-3" style={{
                ...
                maxWidth: 520, lineHeight: 1.6, margin: "0 auto 16px",
                fontWeight: 400,
              }}>
                {heading.sub}
              </p>
